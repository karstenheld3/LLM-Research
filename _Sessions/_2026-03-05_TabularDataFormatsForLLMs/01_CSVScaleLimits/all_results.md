...
|-------------------|-----------|-------------------|--------|-------------|---------------|-----------|---------|----------|
| claude-opus-4.7   | Anthropic | adaptive_thinking | high   | 843+        | (cancelled)   | -         | ~$30+   | ~10.0 min |
| gpt-5-mini        | OpenAI    | reasoning         | high   | 675+        | (errors)      | -         | $0.00   | -        |
| claude-opus-4.6   | Anthropic | adaptive_thinking | high   | 667         | comprehension | 55.4%     | ~$18+   | ~4.5 min |
| gpt-5-mini        | OpenAI    | reasoning         | medium | 500         | comprehension | 7.1%      | $0.40   | ~3.5 min |
| gpt-5.4           | OpenAI    | reasoning         | medium | 492         | comprehension | 6.8%      | $2.49   | ~2.6 min |
| gpt-5             | OpenAI    | reasoning         | high   | 492         | truncation    | 8.0%      | $2.73   | ~45.2 min |
| gpt-5             | OpenAI    | reasoning         | medium | 450         | comprehension | 6.4%      | $2.97   | ~4.5 min |
| gpt-5.5           | OpenAI    | reasoning         | medium | 437         | comprehension | 6.8%      | $8.15   | ~1.6 min |
...
| claude-sonnet-4   | Anthropic | thinking          | medium | 187         | truncation    | 25.1%     | $3.41   | ~2.0 min |
...
| gpt-5-mini        | OpenAI    | reasoning         | low    | 65          | comprehension | 4.3%      | $0.07   | ~48 sec  |
| claude-opus-4.7   | Anthropic | adaptive_thinking | medium | 12          | comprehension | 5.1%      | $1.96   | ~6 sec   |
| claude-haiku-4.5  | Anthropic | temperature       | medium | 9           | comprehension | 8.3%      | $0.09   | ~2 sec   |
| claude-opus-4.6   | Anthropic | adaptive_thinking | medium | 6           | comprehension | 16.9%     | $1.12   | ~5 sec   |
...
| Effort | Scale Limit | Cost    | Time/req |
|--------|-------------|---------|----------|
| medium | 12          | $1.96   | ~6 sec   |
| high   | 843+        | ~$30+   | ~10.0 min |
...
| medium | 450         | $2.97   | ~4.5 min |
| high   | 492         | $2.73   | ~45.2 min |
