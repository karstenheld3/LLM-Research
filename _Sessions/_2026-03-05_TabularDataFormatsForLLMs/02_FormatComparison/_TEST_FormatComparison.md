...
- `01_CSVScaleLimits/_INFO_01_CSVScaleLimits-TestResults.md [TBLF-IN02]` for CSV baseline scale limits

**Produces:**
- `_INFO_01_FormatComparison-TestResults.md [TBLF-IN05]` - test result data
- `_INFO_02_FormatComparison-Findings.md [TBLF-IN06]` - findings and analysis

## Status

**Status**: 56/56 tests complete.

**Test results**: See `_INFO_01_FormatComparison-TestResults.md [TBLF-IN05]`
**Findings and verdicts**: See `_INFO_02_FormatComparison-Findings.md [TBLF-IN06]`

**IMPORTANT (TBLF-FL-005)**: This test uses a simplified dataset (7/7 columns) that differs from Test 01 (7/20 columns). Results not directly comparable.
...
- Removed: Hypothesis status table and executive summary (moved to `_INFO_02_FormatComparison-Findings.md [TBLF-IN06]`)
- Updated: Dependencies and added "Produces" section with new document references
- Changed: Per 4-document methodology (`_INFO_LLM_TEST_METHODOLOGY.md [TBLF-IN04]`)
