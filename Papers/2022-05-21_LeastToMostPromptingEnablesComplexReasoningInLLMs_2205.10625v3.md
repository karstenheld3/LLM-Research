...
<transcription_notes>
- Page layout: Conference paper first page. Title centered across full width; author list centered under title; affiliation line "†Google Research, Brain Team" under authors.
- Abstract appears full-width under authors and affiliation. Body text begins in two-column format under "1 INTRODUCTION".
- Left margin contains vertical arXiv identifier: "arXiv:2205.10625v3 [cs.AI] 16 Apr 2023" (decorative).
- Footer: centered page number "1". A footnote line "*Corresponding to: dennyzhou@google.com" appears above page number.
- Fonts: serif, small caps for section headings. Columns justified. No figures or tables on this page.
- Notes on unclear text: None; all visible text transcribed exactly. The last line of the page ends mid-sentence ("previously solved") and continues on the next page.
<!-- Decorative: arXiv identifier vertical text; top horizontal rule; conference watermark -->
</transcription_notes>
...
```ascii
[FLOW DIAGRAM - LEAST-TO-MOST PROMPTING EXAMPLE]

Stage 1: Decompose Question into Subquestions
──────────────────────────────────────────────────────────────────────────────
[PROCESS] Q: It takes Amy 4 minutes to climb to the top
  ...
  ──> [PROCESS] Language Model (blue box) [PROCESS]
           |
           V
  ──> [PROCESS] A: To solve "How many times can she slide before it closes?",
                 we need to first solve: "How long does each trip take?"  (orange box)

──────────────────────────────────────────────────────────────────────────────
Stage 2: Sequentially Solve Subquestions
──────────────────────────────────────────────────────────────────────────────
Step 1:
[PROCESS] Q (Subquestion 1): How long does each trip take?
  ──> [PROCESS] Language Model (blue box) [PROCESS]
           |
           V
  ──> [PROCESS] A: It takes Amy 4 minutes to climb and 1 minute to slide down.
                 4 + 1 = 5. So each trip takes 5 minutes. (green box)

(append model answer to Subquestion 1)  [DATABASE] (stores answered subquestions) (pending)

Step 2:
[PROCESS] Q (Subquestion 2): How many times can she slide before it closes?
  (with appended answer: each trip takes 5 minutes)
  ──> [PROCESS] Language Model (blue box) [PROCESS]
           |
           V
  ──> [PROCESS] A: The water slide closes in 15 minutes. Each trip takes 5 minutes.
                 So Amy can slide 15 ÷ 5 = 3 times before it closes. (orange box)
```

<transcription_json>
{"chart_type":"flow_diagram","title":"Least-to-most prompting example (Figure 1)","stages":[{"stage":"Stage 1: Decompose Question into Subquestions","nodes":[{"id":"q_orig","type":"PROCESS","label":"Q: original problem","text":"It takes Amy 4 minutes to climb to the top of a slide. It takes her 1 minute to slide down. The water slide closes in 15 minutes. How many times can she slide before it closes?"},{"id":"lm_1","type":"PROCESS","label":"Language Model","text":"(language model queried to decompose)"},{"id":"a_decomp","type":"PROCESS","label":"A: decomposition answer","text":"To solve \"How many times can she slide before it closes?\", we need to first solve: \"How long does each trip take?\""}],"edges":[["q_orig","lm_1"],["lm_1","a_decomp"]]} ,{"stage":"Stage 2: Sequentially Solve Subquestions","nodes":[{"id":"q_sub1","type":"PROCESS","label":"Q: Subquestion 1","text":"How long does each trip take?"},{"id":"lm_2","type":"PROCESS","label":"Language Model","text":"(language model queried to solve subquestion 1)"},{"id":"a_sub1","type":"PROCESS","label":"A: Subquestion 1 answer","text":"It takes Amy 4 minutes to climb and 1 minute to slide down. 4 + 1 = 5. So each trip takes 5 minutes."},{"id":"store","type":"DATABASE","label":"Appended model answer","text":"Store answer to subquestion 1 (each trip takes 5 minutes)."},{"id":"q_sub2","type":"PROCESS","label":"Q: Subquestion 2","text":"How many times can she slide before it closes? (with appended answer: each trip takes 5 minutes)"},{"id":"lm_3","type":"PROCESS","label":"Language Model","text":"(language model queried to solve subquestion 2)"},{"id":"a_sub2","type":"PROCESS","label":"A: Final answer","text":"The water slide closes in 15 minutes. Each trip takes 5 minutes. So Amy can slide 15 ÷ 5 = 3 times before it closes."}],"edges":[["q_sub1","lm_2"],["lm_2","a_sub1"],["a_sub1","store"],["q_sub2","lm_3"],["lm_3","a_sub2"]]}],"notes":"Nodes labeled with type. 'store' node represented as [DATABASE]. Some decorative prompt examples omitted in figure (pending).","data":[{"value_items":[{"label":"Amy climb time (minutes)","value":4},{"label":"Amy slide-down time (minutes)","value":1},{"label":"Slide closure time (minutes)","value":15},{"label":"Each trip time (minutes)","value":5},{"label":"Number of trips possible","value":3,"calculation":"15 ÷ 5 = 3"}]}]}
</transcription_json>

<transcription_notes>
- Type: Two-stage flow diagram illustrating least-to-most prompting.
- Visual elements:
  - Stage headings: "Stage 1: Decompose Question into Subquestions" and "Stage 2: Sequentially Solve Subquestions".
  - Boxes: Question and Answer boxes; Language Model boxes are blue; Subquestion answer boxes are green; original question and final answers are orange.
  - Connecting arrows show flow: original question -> LM -> decomposition suggestion; then sequential LM calls solving subquestions with appended previous answers.
  - There is a dashed horizontal divider between stages.
  - Some demonstration examples for each stage's prompt are omitted in figure (visual placeholders present) — marked (pending) in diagram.
- Colors: blue = Language Model boxes; green = solved subquestion answers; orange = original/final questions and answers.
- All numeric values extracted and included in JSON: 4, 1, 15, 5, 3.
</transcription_notes>
</transcription_image>
...
<transcription_table>
**Table 1: Least-to-most prompt context (decomposition) for the last-letter-concatenation task. It can decompose arbitrary long lists into sequential [unclear: subsists?] with an accuracy of 100%.**

| Q | A |
|---|---|
| "think, machine, learning" | "think", "think, machine", "think, machine, learning" |

<transcription_json>
{"table_type": "data_table", "title": "Least-to-most prompt context (decomposition) for the last-letter-concatenation task", "columns": ["Q", "A"], "data": [{"Q": "think, machine, learning", "A": ["think", "think, machine", "think, machine, learning"]}], "notes": "Decomposes a list into a sequence of sublists; accuracy reported as 100% on image caption."}
</transcription_json>

<transcription_notes>
- Visual: A boxed exemplar separated by horizontal rules above and below.
- Font: Monospaced-like example lines for Q/A.
- Colors: black text on white background.
- The caption contains the phrase "sequential [unclear: subsists?]" which is unreadable/confidently uncertain in the image; marked as [unclear: subsists?].
</transcription_notes>
</transcription_table>
...
| Q | A |
|---|---|
| "think, machine" | The last letter of "think" is "k". The last letter of "machine" is "e". Concatenating "k", "e" leads to "ke". So, "think, machine" outputs "ke". |
| "think, machine, learning" | "think, machine" outputs "ke". The last letter of "learning" is "g". Concatenating "ke", "g" leads to "keg". So, "think, machine, learning" outputs "keg". |

<transcription_json>
{"table_type": "data_table", "title": "Least-to-most prompt context (solution) for the last-letter-concatenation task", "columns": ["Q", "A"], "data": [{"Q": "think, machine", "A": "The last letter of \"think\" is \"k\". The last letter of \"machine\" is \"e\". Concatenating \"k\", \"e\" leads to \"ke\". So, \"think, machine\" outputs \"ke\"."}, {"Q": "think, machine, learning", "A": "\"think, machine\" outputs \"ke\". The last letter of \"learning\" is \"g\". Concatenating \"ke\", \"g\" leads to \"keg\". So, \"think, machine, learning\" outputs \"keg\"."}], "notes": "Two exemplars: base case and recursive step; shown as exemplar solution prompts."}
</transcription_json>

<transcription_notes>
- Visual: Two boxed exemplar solution entries separated by horizontal rules.
- Style: Explanatory sentences for each Q → A mapping; examples demonstrate base case ("think, machine") and recursive step ("think, machine, learning").
- No colors or icons besides plain black text.
</transcription_notes>
</transcription_table>
...
<transcription_table>
**Table 3: Chain-of-thought prompt context for the last-letter-concatenation task**
...
<transcription_json>
{"table_type":"example_table","title":"Chain-of-thought prompt context for the last-letter-concatenation task","columns":["Context"],"data":[{"Context":"Q: \"think, machine\""},{"Context":"A: The last letter of \"think\" is \"k\". The last letter of \"machine\" is \"e\". Concatenating \"k\", \"e\" leads to \"ke\". So, \"think, machine\" outputs \"ke\"."},{"Context":"Q: \"think, machine, learning\""},{"Context":"A: The last letter of \"think\" is \"k\". The last letter of \"machine\" is \"e\". The last letter of \"learning\" is \"g\". Concatenating \"k\", \"e\", \"g\" leads to \"keg\". So, \"think, machine, learning\" outputs \"keg\"."}]}
</transcription_json>

<transcription_notes>
- Type: Example prompt context displayed as an inset box with horizontal rules above and below in the original.
- Visual: Monospaced-like paragraph with short Q/A lines separated by spacing and ruled lines.
- No colors or icons.
</transcription_notes>
</transcription_table>
...
<transcription_json>
{"table_type":"data_table","title":"Accuracies of different prompting methods on the last-letter-concatenation task","columns":["Method","L = 4","L = 6","L = 8","L = 10","L = 12"],"data":[{"Method":"Standard prompting","L = 4":0.0,"L = 6":0.0,"L = 8":0.0,"L = 10":0.0,"L = 12":0.0},{"Method":"Chain-of-Thought","L = 4":84.2,"L = 6":69.2,"L = 8":50.2,"L = 10":39.8,"L = 12":31.8},{"Method":"Least-to-Most","L = 4":94.0,"L = 6":88.4,"L = 8":83.0,"L = 10":76.4,"L = 12":74.0}],"unit":"percent","notes":"Results reported for code-davinci-002 in GPT-3; testing lists of length L constructed from Wiktionary sample, 500 lists per length."}
</transcription_json>

<transcription_notes>
- Source: Experimental results in paper.
- Visual: Table with vertical and horizontal rules; Standard prompting shows zeros across all lengths.
- Units: percentages (accuracy).
- The caption in the original: "Table 4: Accuracies of different prompting methods on the last-letter-concatenation task. The length of testing lists increases from 4 to 12."
</transcription_notes>
</transcription_table>
...
<transcription_table>
**Table 5: Example commands in SCAN and their corresponding action sequences.**
...
<transcription_json>
{"table_type":"data_table","title":"Example commands in SCAN and their corresponding action sequences","columns":["Command","Action Sequence"],"data":[{"Command":"\"look thrice after jump\"","Action Sequence":"JUMP LOOK LOOK LOOK"},{"Command":"\"run left and walk\"","Action Sequence":"TURN_LEFT RUN WALK"},{"Command":"\"look opposite right\"","Action Sequence":"TURN_RIGHT TURN_RIGHT LOOK"}]}
</transcription_json>

<transcription_notes>
- Table shows three example natural language commands (left column) and their corresponding tokenized action sequences (right column).
- Formatting: commands shown in quotes; action sequences in uppercase with underscores for TURN_LEFT.
- Source context: SCAN benchmark examples; table enclosed by horizontal rules in original.
</transcription_notes>
</transcription_table>
...
a postprocessing script to expand the Python expressions to generate the final results. However, it
...
<transcription_image>
**Figure / Table 7: Two exemplars (least-to-most / chain-of-thought prompt examples)**

```ascii
[EXEMPLAR 1]
Q: "jump left"
A: The output of "jump left" concatenates: the output of "turn left", the output of "jump".
   "turn left" outputs "TURN_LEFT". "jump" outputs "JUMP". So concatenating the output of
   "turn left" and the output of "jump" leads to "TURN_LEFT" + "JUMP". So the output of "jump left"
   is "TURN_LEFT" + "JUMP".
...
<transcription_json>
{"figure_type":"text_examples","title":"Two exemplars (least-to-most / chain-of-thought prompt examples)","examples":[{"Q":"jump left","A":"Concatenate output of \"turn left\" and \"jump\"; \"turn left\" -> \"TURN_LEFT\"; \"jump\" -> \"JUMP\"; result: \"TURN_LEFT\" + \"JUMP\""},{"Q":"run and look twice","A":"Concatenate output of \"run\" and \"look twice\"; \"run\" -> \"RUN\"; \"look twice\" -> \"LOOK\" * 2; result: \"RUN\" + \"LOOK\" * 2"}]}
</transcription_json>

<transcription_notes>
- Layout: two boxed exemplars stacked vertically with horizontal rules above and below.
- Textual content used as intermediate (Python-like) expressions: string concatenation and repetition.
- No colors apparent; simple black text on white background.
</transcription_notes>
</transcription_image>
...
The chain-of-thought prompt for SCAN uses the same command-mapping context as least-to-most prompting (see Table 7) but it does not use command decomposition, which is exclusively used for least-to-most prompting.
...
<transcription_json>
{"table_type":"data_table","title":"Accuracies (%) of different prompting methods on the test set of SCAN under length split","columns":["Method","Standard prompting","Chain-of-Thought","Least-to-Most"],"data":[{"Method":"code-davinci-002","Standard prompting":16.7,"Chain-of-Thought":16.2,"Least-to-Most":99.7},{"Method":"text-davinci-002","Standard prompting":6.0,"Chain-of-Thought":0.0,"Least-to-Most":76.0},{"Method":"code-davinci-001","Standard prompting":0.4,"Chain-of-Thought":0.0,"Least-to-Most":60.7}],"unit":"percent"}
</transcription_json>

<transcription_notes>
- Table is a simple 3x3 data table with Method as first column and three prompting methods as metrics.
- Values are percentages (%) representing accuracy on SCAN test set under length split.
- The "text-davinci-002" results are based on a random subset of 100 commands (as noted in caption).
</transcription_notes>
</transcription_table>
...
<transcription_json>
{"table_type":"data_table","title":"Accuracies (%) of different prompting methods on GSM8K and DROP","columns":["Method","Non-football (DROP)","Football (DROP)","GSM8K"],"data":[{"Method":"Zero-Shot","Non-football (DROP)":43.86,"Football (DROP)":51.77,"GSM8K":16.38},{"Method":"Standard prompting","Non-football (DROP)":58.78,"Football (DROP)":62.73,"GSM8K":17.06},{"Method":"Chain-of-Thought","Non-football (DROP)":74.77,"Football (DROP)":59.56,"GSM8K":60.87},{"Method":"Least-to-Most","Non-football (DROP)":82.45,"Football (DROP)":73.42,"GSM8K":62.39}],"unit":"%","note":"Only the subset containing numerical problems. Base model: code-davinci-002."}
</transcription_json>

<transcription_notes>
- Table is a 4x4 grid with horizontal rules between header and rows.
- Values are accuracies in percent.
- Visual: simple black text table, no colors.
- Caption below table: "Table 11: Accuracies (%) of different prompting methods on GSM8K and DROP (only the subset containing numerical problems). The base language model is code-davinci-002."
</transcription_notes>
</transcription_table>
...
<transcription_table>
**Table 12: Accuracy by Steps (GSM8K)**
...
<transcription_json>
{
  ...
  "title": "Accuracy by Steps (GSM8K)",
  "columns": ["Method","All","2 Steps","3 Steps","4 steps","≥ 5 steps"],
  "data": [
    {"Method":"Least-to-Most","All":62.39,"2 Steps":74.53,"3 Steps":68.91,"4 steps":59.73,"≥ 5 steps":45.23},
    {"Method":"Chain-of-Thought","All":60.87,"2 Steps":76.68,"3 Steps":67.29,"4 steps":59.39,"≥ 5 steps":39.07}
  ],
  "unit": "percentage",
...
<transcription_notes>
- Location: centered near top of page.
- Table caption (as printed under table): "Table 12: Accuracies (%) of least-to-most prompting and chain-of-thought prompting, broken down by the number of reasoning steps required in the expected solution."
- Visual: simple black-and-white table with horizontal rules; some cells in original appear typeset in bold for emphasis (e.g., "62.39" appears bold).
</transcription_notes>
</transcription_table>
...
Jingfeng Yang, Haoming Jiang, Qingyu Yin, Danqing Zhang, Bing Yin, and Diyi Yang. Seazero: Few-shot compositional semantic parsing with sequential prompts and zero-shot models. arXiv preprint arXiv:2205.07381, 2022.

<transcription_notes>
- Page layout: single-column references list, left-aligned body text, small serif font.
- Header: centered text "Published as a conference paper at ICLR 2023" with a horizontal rule beneath.
- Footer: centered page number "11".
- No figures or tables on this page.
- Minor typographic details preserved as seen (e.g., en-dashes in page ranges, arXiv identifiers).
</transcription_notes>
...
<transcription_page_footer>13</transcription_page_footer>
...
<transcription_page_footer> 14 </transcription_page_footer>
...
<transcription_notes>
- Page layout: single-column academic paper page with running header "Published as a conference paper at ICLR 2023" at top-center and page number "16" centered at bottom.
- Fonts: standard serif (conference paper). Section heading "7.3 DATA GENERATION AND ADDITIONAL RESULTS" uses small-caps/uppercase styling in the source.
- The top of the page continues examples/Q&A from the previous section; these are transcribed verbatim above.
- Bulleted list: 10 random examples of list size 6; each OUT string is the concatenation of the last letters of the IN words.
- Footnote link included exactly as printed.
</transcription_notes>
...
<!-- Column 1 -->
**Table 13: Accuracy of different prompting methods, prompt sizes, and GPT3 models on the last-letter-concatenation task with the length of lists increasing from 4 to 12.**

<transcription_table>
**Table 13: Accuracy of different prompting methods, prompt sizes, and GPT3 models on the last-letter-concatenation task (L = 4..12)**
...
| Chain-of-Thought    | 2 (L2M)    | code-002   | 84.2   | 69.2   | 50.2   | 39.8   | 31.8   |
| Chain-of-Thought    | 4          | code-002   | 88.6   | 77.0   | 53.4   | 44.0   | 37.4   |
| Chain-of-Thought    | 8          | code-002   | 91.0   | 79.8   | 56.8   | 46.8   | 38.4   |
| Chain-of-Thought    | 4          | text-002*  | 87.0   | 64.0   | 46.0   | 25.0   | 14.0   |
| Chain-of-Thought    | 4          | code-001   | 13.0   | 1.8    | 0.0    | 0.0    | 0.0    |
| Least-to-Most       | 2          | code-002   | 94.0   | 88.4   | 83.0   | 76.4   | 74.0   |
| Least-to-Most       | 4          | code-002   | 96.0   | 92.0   | 84.6   | 80.2   | 76.6   |
| Least-to-Most       | 4          | text-002*  | 94.0   | 90.0   | 84.0   | 72.0   | 66.0   |
| Least-to-Most       | 4          | code-001   | 19.6   | 8.4    | 4.0    | 1.0    | 0.1    |

<transcription_json>
{"table_type":"data_table","title":"Table 13: Accuracy of different prompting methods, prompt sizes, and GPT3 models on the last-letter-concatenation task (L = 4..12)","columns":["Prompting method","# Examples","Model","L = 4","L = 6","L = 8","L = 10","L = 12"],"data":[{"Prompting method":"Standard","# Examples":"Any","Model":"Any","L = 4":0.0,"L = 6":0.0,"L = 8":0.0,"L = 10":0.0,"L = 12":0.0},{"Prompting method":"Chain-of-Thought","# Examples":"2","Model":"code-002","L = 4":89.4,"L = 6":75.0,"L = 8":51.8,"L = 10":39.8,"L = 12":33.6},{"Prompting method":"Chain-of-Thought","# Examples":"2 (L2M)","Model":"code-002","L = 4":84.2,"L = 6":69.2,"L = 8":50.2,"L = 10":39.8,"L = 12":31.8},{"Prompting method":"Chain-of-Thought","# Examples":"4","Model":"code-002","L = 4":88.6,"L = 6":77.0,"L = 8":53.4,"L = 10":44.0,"L = 12":37.4},{"Prompting method":"Chain-of-Thought","# Examples":"8","Model":"code-002","L = 4":91.0,"L = 6":79.8,"L = 8":56.8,"L = 10":46.8,"L = 12":38.4},{"Prompting method":"Chain-of-Thought","# Examples":"4","Model":"text-002*","L = 4":87.0,"L = 6":64.0,"L = 8":46.0,"L = 10":25.0,"L = 12":14.0},{"Prompting method":"Chain-of-Thought","# Examples":"4","Model":"code-001","L = 4":13.0,"L = 6":1.8,"L = 8":0.0,"L = 10":0.0,"L = 12":0.0},{"Prompting method":"Least-to-Most","# Examples":"2","Model":"code-002","L = 4":94.0,"L = 6":88.4,"L = 8":83.0,"L = 10":76.4,"L = 12":74.0},{"Prompting method":"Least-to-Most","# Examples":"4","Model":"code-002","L = 4":96.0,"L = 6":92.0,"L = 8":84.6,"L = 10":80.2,"L = 12":76.6},{"Prompting method":"Least-to-Most","# Examples":"4","Model":"text-002*","L = 4":94.0,"L = 6":90.0,"L = 8":84.0,"L = 10":72.0,"L = 12":66.0},{"Prompting method":"Least-to-Most","# Examples":"4","Model":"code-001","L = 4":19.6,"L = 6":8.4,"L = 8":4.0,"L = 10":1.0,"L = 12":0.1}],"unit":"percent"}
</transcription_json>

<transcription_notes>
- Type: Data table extracted from experimental results (Table 13 in paper).
- Models: "code-002" = code-davinci-002; "text-002*" = text-davinci-002 (results based on a subset of 100 random examples, not full 500); "code-001" = code-davinci-001.
- Prompting methods compared: Standard, Chain-of-Thought, Least-to-Most.
- L denotes list length; values are accuracy percentages.
- Visual: table has boxed grid and bold header row in original PDF.
</transcription_notes>
</transcription_table>
...
<transcription_table>
**Table 14: Least-to-most prompting error analysis (20 random failures) — code-davinci-002**

| Error type               | 2 examples L = 4 | 2 examples L = 12 | 4 examples L = 4 | 4 examples L = 12 |
|--------------------------|------------------:|-------------------:|------------------:|-------------------:|
...
<transcription_json>
{"table_type":"data_table","title":"Table 14: Least-to-most prompting error analysis (20 random failures) — code-davinci-002","columns":["Error type","2 examples L = 4","2 examples L = 12","4 examples L = 4","4 examples L = 12"],"data":[{"Error type":"Concatenation error","2 examples L = 4":13,"2 examples L = 12":19,"4 examples L = 4":21,"4 examples L = 12":20},{"Error type":"- Dropping a letter","2 examples L = 4":8,"2 examples L = 12":12,"4 examples L = 4":15,"4 examples L = 12":15},{"Error type":"- Adding a letter","2 examples L = 4":4,"2 examples L = 12":7,"4 examples L = 4":4,"4 examples L = 12":3},{"Error type":"- Wrong order","2 examples L = 4":1,"2 examples L = 12":0,"4 examples L = 4":2,"4 examples L = 12":2},{"Error type":"Wrong template","2 examples L = 4":7,"2 examples L = 12":1,"4 examples L = 4":0,"4 examples L = 12":0},{"Error type":"Incorrect last letter","2 examples L = 4":2,"2 examples L = 12":1,"4 examples L = 4":1,"4 examples L = 12":2},{"Error type":"Copy error","2 examples L = 4":0,"2 examples L = 12":0,"4 examples L = 4":1,"4 examples L = 12":0}],"unit":"count"}
</transcription_json>

<transcription_notes>
- Type: Error analysis table summarizing counts of error types across 20 random failures for code-davinci-002.
- Columns: counts for 2-example and 4-example prompt contexts, each at list lengths L = 4 and L = 12.
- Visual: small boxed table in original PDF, with hyphenated subrows under "Concatenation error".
</transcription_notes>
</transcription_table>
...
<!-- Section 2 -->
## Examples of concatenation errors.
...
### Example of incorrect last letter.
...
### Example of wrong template application.
...
- "upper" outputs "er". The last letter of "unexpectedly" is "y". Concatenating "er", "y" leads to "ery". So, "upper, unexpectedly" outputs "cery".
...
As a consequence, the model predicts the sequence "erynn" instead of "rynn".

### Example of copy error.
...
<transcription_page_footer>20</transcription_page_footer>
...
“herbert” is “t”. Concatenating “s”, “y”, “e”, “d”, “y”, “s”, “p”, “n”, “y”, “t”, “t” leads to “syedysspnytt”.  
So, “brightness, preparatory, intense, accumulated, reluctantly, nets, inquiries, grip, inquisition, alley, innocent, herbert” outputs “syedysspnytt”.
...
<!-- Decorative: horizontal rules at top and between sections -->
...
<!-- Section 2 -->
<!-- Column 1 -->
<!-- (Remaining Q/A for this example continues on next page) -->
...
A: "supper, procession, region" outputs "rnn". The last letter of "ruby" is "y". Concatenating: "rnn", "y" leads to "rnny". So, "supper, procession, region, ruby" outputs "rnny".
...
Solution:
Q: "release, appeared"
A: The last letter of "release" is "e". The last letter of "appeared" is "d". Concatenating: "e", "d" leads <!-- unclear continuation --> [unclear]
...
A: “complexion, criminal, assume, seven, driver, hero, horse, purpose, zeus” outputs “nlenroees”. The last letter of “joint” is “t”. Concatenating: “nlenroees”, “t” leads to “nlenroeest”. So, “complexion, criminal, assume, seven, driver, hero, horse, purpose, zeus, joint” outputs “nlenroeest”.
...
A: "provoked, columbia, sir, principal, seven" outputs "darln". The last letter of "extreme" is "e". Concatenating: "darln", "e" leads to "darlne". So, "provoked, columbia, sir, principal, seven, extreme" outputs "darlne".

Q: "provoked, columbia, sir, principal, seven, extreme, timothy"  
A: "provoked, columbia, sir, principal, seven, extreme" outputs "darlne". The last letter of "timothy" is "y". Concatenating: "darlne", "y" leads to "darlney". So, "provoked, columbia, sir, principal, seven, extreme, timothy" outputs "darlney".

Q: "provoked, columbia, sir, principal, seven, extreme, timothy, submitted"  
A: "provoked, columbia, sir, principal, seven, extreme, timothy" outputs "darlney". The last letter of "submitted" is "d". Concatenating: "darlney", "d" leads to "darlneyd". So, "provoked, columbia, sir, principal, seven, extreme, timothy, submitted" outputs "darlneyd".

Q: "provoked, columbia, sir, principal, seven, extreme, timothy, submitted, considered"  
A: "provoked, columbia, sir, principal, seven, extreme, timothy, submitted" outputs "darlneyd". The last letter of "considered" is "d". Concatenating: "darlneyd", "d" leads to "darlneydd". So, "provoked, columbia, sir, principal, seven, extreme, timothy, submitted, considered" outputs "darlneydd".

Q: "provoked, columbia, sir, principal, seven, extreme, timothy, submitted, considered, spies"  
A: "provoked, columbia, sir, principal, seven, extreme, timothy, submitted, considered" outputs "darlneydd". The last letter of "spies" is "s". Concatenating: "darlneydd", "s" leads to "darlneydds". So, "provoked, columbia, sir, principal, seven, extreme, timothy, submitted, considered, spies" outputs "darlneydds".

Q: "provoked, columbia, sir, principal, seven, extreme, timothy, submitted, considered, spies, dost"  
A: "provoked, columbia, sir, principal, seven, extreme, timothy, submitted, considered, spies" outputs "darlneydds". The last letter of "dost" is "t". Concatenating: "darlneydds", "t" leads to "darlneyddst". So, "provoked, columbia, sir, principal, seven, extreme, timothy, submitted, considered, spies, dost" outputs "darlneyddst".

Q: "provoked, columbia, sir, principal, seven, extreme, timothy, submitted, considered, spies, dost, treasury"  
A: "provoked, columbia, sir, principal, seven, extreme, timothy, submitted, considered, spies, dost" outputs "darlneyddst". The last letter of "treasury" is "y". Concatenating: "darlneyddst", "y" leads to "darlneyddsty". So, "provoked, columbia, sir, principal, seven, extreme, timothy, submitted, considered, spies, dost, treasury" outputs "darlneyddsty".
...
<transcription_page_footer>28</transcription_page_footer>
...
Q: “walk opposite left”
A: The output of “walk opposite left” concatenates: the output of “turn opposite left”, the output of “walk”. “turn opposite left” outputs “TURN_LEFT” * 2. “walk” outputs “WALK”. So concatenating the output of “turn opposite left” and the output of “walk” leads to “TURN_LEFT” * 2 + “WALK”. So the [unclear]
...
<transcription_page_footer>31</transcription_page_footer>
...
<!-- Section 1 -->
<transcription_table>
**Table 15: Least-to-most prompting error analysis**
...
<transcription_json>
{"table_type": "data_table", "title": "Least-to-most prompting error analysis", "columns": ["Error type", "code-002", "code-001", "text-002"], "data": [{"Error type":"Decomposition error","code-002":0,"code-001":7,"text-002":1},{"Error type":"Incorrect interpretation of \"twice\" and \"thrice\"","code-002":6,"code-001":10,"text-002":16},{"Error type":"- Following \"around\"","code-002":6,"code-001":3,"text-002":15},{"Error type":"- Following \"opposite\"","code-002":0,"code-001":3,"text-002":1},{"Error type":"- Other","code-002":0,"code-001":4,"text-002":null},{"Error type":"\"after\" interpreted as \"and\"","code-002":7,"code-001":4,"text-002":0},{"Error type":"Incorrect interpretation of \"left\" and \"right\"","code-002":0,"code-001":0,"text-002":4},{"Error type":"Copy error","code-002":0,"code-001":4,"text-002":0}], "notes": "Counts are number of errors observed in sampled failures for each model. The value null indicates a cell that was unreadable in the source image."}
</transcription_json>

<transcription_notes>
- Layout: single boxed table with header row shaded (visual shading not transcribed).
- Columns: leftmost column is wide text; three narrow numeric columns labeled code-002, code-001, text-002.
- The cell for row "- Other" under text-002 was illegible in the image and is marked [unclear] in the table and null in the JSON.
- Table caption (below table in image): "Table 15: Least-to-most prompting error analysis of 20 random failures for the models code-davinci-001 and text-davinci-002 and all 13 errors for the model code-davinci-002. Note that for some examples, the model made more than one type of error."
</transcription_notes>
</transcription_table>
...
<!-- Section 4 -->
Examples of incorrect interpretation of "twice" and "thrice".
...
<transcription_page_footer> 32 </transcription_page_footer>
...
### Examples of incorrect interpretation of “left” and “right”.

In the example “look opposite right thrice after look around left thrice”, the text-davinci-002 model translates the component “look left” to “LOOK” instead of “TURN_LEFT LOOK”. As a consequence, the whole command is translated to “LOOK” * 4 * 3 + (“TURN_RIGHT” * 2 + “LOOK”) * 3 instead of (“TURN_LEFT” * 2 + “LOOK”) * 3 + (“TURN_RIGHT” * 2 + “LOOK”) * 3.
...
Golden:
TURN_LEFT TURN_LEFT WALK TURN_LEFT TURN_LEFT TURN_LEFT WALK TURN_LEFT TURN_LEFT WALK
<!-- [unclear: some occurrences of "TURN_LEFT" in the Golden line may appear in the source without underscores as "TURN LEFT"; transcription above uses underscores where typical in the paper] -->
...
<!-- Section 1 -->
TURN_LEFT JUMP TURN_LEFT JUMP TURN_LEFT JUMP TURN_LEFT JUMP TURN_LEFT JUMP TURN_LEFT JUMP TURN_LEFT JUMP TURN_LEFT JUMP TURN_LEFT JUMP TURN_LEFT JUMP
...
**Golden:**  
TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_RIGHT TURN_RIGHT TURN_RIGHT TURN_RIGHT TURN_RIGHT TURN_RIGHT TURN_RIGHT TURN_RIGHT TURN_RIGHT TURN_RIGHT TURN_RIGHT TURN_RIGHT [unclear]

**Solution:**  
Q: "walk around left twice and turn around right thrice"  
A: The output of "walk around left twice and turn around right thrice" concatenates: the output of "walk around left", the output of "walk around left", the output of "turn around right", the output of "turn around right", the output of "turn around right". "walk around left" outputs ("TURN_LEFT" + "WALK") * 4. "turn around right" outputs "TURN_RIGHT" * 4. So concatenating the output of "walk around left", the output of "turn around right", the output of "turn around right", the output of "turn around right" leads to ("TURN_LEFT" + "WALK") * 4 + ("TURN_LEFT" + "WALK") * 4 + "TURN_RIGHT" * 4 + "TURN_RIGHT" * 4 + "TURN_RIGHT" * 4. So the output of "walk around left twice and turn around right thrice" is ("TURN_LEFT" + "WALK") * 4 + ("TURN_LEFT" + "WALK") * 4 + "TURN_RIGHT" * 4 + "TURN_RIGHT" * 4 + "TURN_RIGHT" * 4.
...
**Golden:**  
TURN_LEFT RUN TURN_LEFT RUN TURN_LEFT RUN TURN_LEFT RUN TURN_LEFT RUN TURN_LEFT RUN TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT [unclear]
...
**Golden:**  
TURN_LEFT RUN TURN_LEFT RUN TURN_LEFT RUN TURN_LEFT RUN TURN_LEFT RUN TURN_LEFT RUN TURN_LEFT RUN TURN_LEFT RUN TURN_LEFT RUN TURN_LEFT RUN TURN_LEFT RUN TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK [unclear]

**Solution:**  
Q: "run around left twice and walk around left thrice"  
A: The output of "run around left twice and walk around left thrice" concatenates: the output of "run around left", the output of "run around left", the output of "walk around left", the output of "walk around left", the output of "walk around left". "run around left" outputs ("TURN_LEFT" + "RUN") * [unclear]. "walk around left" outputs ("TURN_LEFT" + "WALK") * [unclear]. So concatenating accordingly yields ("TURN_LEFT" + "RUN") * [unclear] + ("TURN_LEFT" + "RUN") * [unclear] + ("TURN_LEFT" + "WALK") * [unclear] + ("TURN_LEFT" + "WALK") * [unclear] + ("TURN_LEFT" + "WALK") * [unclear]. [unclear: some repetition counts are not legible]
...
Golden:
```
TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT JUMP TURN_LEFT JUMP TURN_LEFT JUMP TURN_LEFT JUMP TURN_LEFT JUMP TURN_LEFT JUMP TURN_LEFT JUMP TURN_LEFT JUMP TURN_LEFT JUMP TURN_LEFT JUMP TURN_LEFT JUMP
```
<small>[unclear: exact count of repeated "TURN_LEFT" and "JUMP TURN_LEFT" groups may be imprecise in transcription above]</small>
...
Golden:
```
TURN_RIGHT LOOK TURN_RIGHT LOOK TURN_RIGHT LOOK TURN_RIGHT LOOK TURN_RIGHT LOOK TURN_RIGHT LOOK TURN_RIGHT LOOK TURN_RIGHT LOOK TURN_RIGHT LOOK TURN_RIGHT LOOK TURN_RIGHT LOOK TURN_RIGHT LOOK TURN_RIGHT LOOK TURN_RIGHT LOOK TURN_RIGHT LOOK TURN_RIGHT LOOK TURN_RIGHT LOOK TURN_RIGHT LOOK TURN_RIGHT LOOK
```
<small>[unclear: exact repetition counts may be imprecise]</small>
...
A: The output of "run around left thrice and run left twice" concatenates: the output of "run around left thrice", the output of "run left twice". [page continues; remaining text truncated here]
...
<!-- Decorative: horizontal rules separating examples -->
...
### Golden:
WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT  
WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT  
WALK TURN_LEFT WALK TURN_LEFT WALK
...
### Golden:
TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP  
TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP
...
### Golden:
TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT  
WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT RUN
...
TURN_LEFT JUMP TURN_LEFT JUMP TURN_LEFT JUMP TURN_LEFT JUMP TURN_RIGHT TURN_RIGHT WALK
...
### Golden:
TURN_RIGHT RUN TURN_RIGHT RUN TURN_RIGHT RUN TURN_RIGHT RUN TURN_RIGHT RUN  
TURN_RIGHT RUN TURN_RIGHT RUN TURN_RIGHT RUN TURN_RIGHT RUN TURN_RIGHT RUN TURN_RIGHT RUN TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT

### Decomposition:
Q: "turn around left thrice after run around right thrice"  
A: "turn around left thrice" can be solved by: "turn left", "turn around left", "turn around left thrice". "run around right thrice" can be solved by: "run right", "run around right", "run around right thrice". So, "turn around left thrice after run around right thrice" can be solved by: "turn left", "turn around left thrice", "run right", "run around right", "run around right thrice".

<transcription_page_footer> 37 </transcription_page_footer>
...
### Golden:
TURN_LEFT LOOK TURN_LEFT LOOK TURN_LEFT LOOK TURN_LEFT LOOK TURN_LEFT LOOK TURN_LEFT LOOK TURN_LEFT LOOK TURN_LEFT LOOK TURN_LEFT LOOK TURN_LEFT LOOK TURN_LEFT LOOK TURN_LEFT LOOK TURN_LEFT LOOK TURN_LEFT [unclear: remaining tokens in golden sequence not fully legible]
...
<!-- Section 1 -->
The output of "look left", the output of "look left". "look left" outputs "TURN_LEFT" + "LOOK". So repeating the output of "look left" four times leads to ("TURN_LEFT" + "LOOK") * 4. So the output of "look around left" is ("TURN_LEFT" + "LOOK") * 4.
...
**Golden:**  
TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT TURN_LEFT [unclear: continued sequence of "TURN_LEFT" and "JUMP" tokens in multiple repetitions across lines; exact spacing and count unclear]

<!-- transcription_notes -->
- Visual: Bold section title, then label "Golden:" followed by a long single-column sequence of uppercase tokens ("TURN_LEFT", "JUMP") arranged across multiple wrapped lines.
- The long sequence contains many repeated "TURN_LEFT" tokens followed by alternating "JUMP TURN_LEFT" pairs; exact token counts at line wraps are unclear in places.
<!-- end transcription_notes -->
...
So, "turn around left thrice and jump around left thrice" can be solved by: "turn left", "turn around left", "turn around left thrice", "jump left", "jump around left", "jump around left thrice".
...
<transcription_page_footer>39</transcription_page_footer>
...
**Golden:**  
TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK [unclear: remaining repetitions?]
...
Q: “walk around right”  
A: The output of “walk around right” concatenates: the output of “walk right”, the output of “walk right”, the output of “walk right”, the output of “walk right”. “walk right” outputs “TURN_RIGHT” + “WALK”. So repeating the output of “walk right” four times leads to (“TURN_RIGHT” + “WALK”) * 4. So the output of “walk around right” is (“TURN_RIGHT” + “WALK”) * 4.
...
**Golden:**  
TURN_RIGHT TURN RIGHT JUMP TURN RIGHT TURN RIGHT JUMP TURN RIGHT JUMP [unclear: remaining sequence/not fully legible]
...
<!-- Section 1 -->
TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP
...
"jump around right thrice" can be solved by: "jump right", "jump around right", "jump around right thrice". So, "jump opposite right twice and jump around right thrice" can be solved by: "jump opposite right", "jump opposite right twice", "jump right", "jump around right", "jump around right thrice".
...
Golden:  
TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_RIGHT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK
...
So, "walk around left thrice after walk around right twice" can be solved by: "walk left", "walk around left", "walk around left thrice", "walk right", "walk around right", "walk around right twice".
...
Golden:
TURN_LEFT RUN TURN_LEFT RUN TURN_LEFT RUN TURN_LEFT RUN TURN_LEFT RUN TURN_LEFT RUN TURN_LEFT RUN TURN_LEFT RUN TURN_LEFT RUN TURN_LEFT RUN TURN_LEFT RUN TURN_LEFT RUN TURN_RIGHT RUN TURN_RIGHT RUN TURN_RIGHT RUN TURN_RIGHT RUN TURN_RIGHT RUN TURN_RIGHT RUN TURN_RIGHT RUN TURN_RIGHT RUN TURN_RIGHT RUN TURN_RIGHT RUN TURN_RIGHT RUN TURN_RIGHT

Decomposition:
Q: "run around left thrice after run around right twice"  
A: "run around left thrice" can be solved by: "run left", "run around left", "run around left thrice".  
"run around right twice" can be solved by: "run right", "run around right", "run around right twice".  
So, "run around left thrice after run around right twice" can be solved by: "run left", "run around left", "run around left thrice", "run right", "run around right", "run around right twice".

<transcription_page_footer>42</transcription_page_footer>
...
Q: "run around left"  
A: The output of "run around left" concatenates: the output of "run left", the output of "run left", the output of "run left", "run left" outputs "TURN_LEFT" + "RUN". So repeating the output of "run around left" four times leads to ("TURN_LEFT" + "RUN") * 4. So the output of "run around left" is ("TURN_LEFT" + "RUN") * 4.
...
Q: "run around right"  
A: The output of "run around right" concatenates: the output of "run right", the output of "run right", the output of "run right", "run right" outputs "TURN_RIGHT" + "RUN". So repeating the output of "run around right" four times leads to ("TURN_RIGHT" + "RUN") * 4. So the output of "run around right" is ("TURN_RIGHT" + "RUN") * 4.
...
Golden:  
TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP TURN_RIGHT JUMP

Decomposition:  
Q: "jump opposite right twice after jump around right thrice"  
A: "jump opposite right twice" can be solved by: "jump opposite right", "jump opposite right twice". "jump around right thrice" can be solved by: "jump right", "jump around right", "jump around right thrice".

<transcription_notes>
- Page contains a centered header: "Published as a conference paper at ICLR 2023" with a horizontal rule beneath.
- Main content: two primary sections separated by a horizontal divider.
- Footer/page number centered at bottom: "43".
- No figures or tables on this page.
</transcription_notes>
...
### Golden:
TURN_RIGHT WALK TURN_RIGHT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK TURN_LEFT WALK
...
<transcription_page_footer> 45 </transcription_page_footer>
...
<transcription_table>
**Table 16: Accuracies (%) of zero-shot and prompting methods with the GPT-3 text-davinci-002 model on the numerical reasoning subset of DROP**
...
<transcription_json>
{"table_type": "data_table", "title": "Accuracies (%) of zero-shot and prompting methods with the GPT-3 text-davinci-002 model on the numerical reasoning subset of DROP", "columns": ["Prompting method", "Non-football (500 cases)", "Football (500 cases)"], "data": [{"Prompting method": "Zero-Shot", "Non-football (500 cases)": 27.00, "Football (500 cases)": 31.60}, {"Prompting method": "Standard prompting", "Non-football (500 cases)": 49.40, "Football (500 cases)": 54.40}, {"Prompting method": "Chain-of-Thought", "Non-football (500 cases)": 60.80, "Football (500 cases)": 57.40}, {"Prompting method": "Least-to-Most", "Non-football (500 cases)": 74.20, "Football (500 cases)": 63.40}], "unit": "percent", "notes": "Evaluated on 500 randomly sampled non-football/football examples"}
</transcription_json>

<transcription_notes>
- Table visual: small bordered table centered on page with a small header label "text-davinci-002" above the column headers (rendered in the paper). 
- Bold emphasis appears on the Best values in the printed table (Least-to-Most row values).
- Units: percentages (%) reported with two decimal places.
- Source/context: numerical reasoning subset of DROP; evaluated on 500 randomly sampled non-football/football examples.
</transcription_notes>
</transcription_table>
...
<transcription_page_footer> Page 46 </transcription_page_footer>
...
<transcription_json>
{"table_type":"data_table","title":"Accuracies (%) of zero-shot and prompting methods with a pretrained language model with 540 billion parameters (lm-540)","columns":["Prompting method","Non-football (3988 cases)","Football (1862 cases)"],"data":[{"Prompting method":"Zero-Shot","Non-football (3988 cases)":48.42,"Football (1862 cases)":44.95},{"Prompting method":"Standard prompting","Non-football (3988 cases)":56.54,"Football (1862 cases)":60.47},{"Prompting method":"Chain-of-Thought","Non-football (3988 cases)":63.84,"Football (1862 cases)":67.35},{"Prompting method":"Least-to-Most","Non-football (3988 cases)":79.24,"Football (1862 cases)":69.98}],"unit":"%","model":"lm-540 (540 billion parameters)"}
</transcription_json>

<transcription_notes>
- Table has a narrow top label cell reading "lm-540b" centered above the columns.
- The "Least-to-Most" row values (79.24 and 69.98) are typeset bold in the source.
- Columns: "Non-football (3988 cases)" and "Football (1862 cases)" — case counts are part of the column headers.
- Visual: thin single-line table borders, centered numeric alignment.
</transcription_notes>
</transcription_table>
...
A: According to the passage, Stafford threw five passing touchdowns and three were to Johnson. 5 - 3 = 2. So the answer is 2.
...
The gender distribution of the population was 50.2% male and 49.8% female. Of the adult population, 29 people or 14.6% of the population are between 20 and 29 years old. 28 people or 14.1% are [unclear]

<transcription_page_footer>48</transcription_page_footer>
...
A: All the touchdown runs are: a 27-yard touchdown run, a 9-yard touchdown run, a 11-yard touchdown run. The smallest number between 27, 9, 11 is 9. The shortest touchdown run was 9 yards.
The answer is 9.
...
<transcription_page_footer> 51 </transcription_page_footer>
...
Q: The Guatemalan authorities were unaware of ongoing contacts between the colonial authorities in Yucatán and the Itza. In the second half of 1695 President Barrios began planning another expedition against the Itza from Verapaz, following harsh criticism of Juan Díaz de Velasco's retreat from near Lake Petén Itzá in April of that year. Barrios died in November, and oidor José de Escals became acting head of the Guatemalan colonial administration. He appointed oidor Bartolomé de Amésqueta to lead the next expedition against the Itza. Amésqueta marched his men through torrential rain from Cahabón to Mopan, arriving on 25 February 1696; the Guatemalans were still unaware of the clashes between García's forces and the Itza. Amésqueta's expedition was suffering from shortages of native labour and supplies. Twenty-five of his 150 men were sick, and his advance stalled as the force rested up at Mopan. Captain Díaz de Velasco volunteered to lead a party of 25 men ahead to the lake; he was accompanied by Dominican friars Cristóbal de Prada and Jacinto de Vargas. He was also accompanied by AjK'ixaw, the Itza nobleman who had been taken prisoner on Díaz's previous expedition, who served as a trusted guide, scout and translator. They set out from Mopan on 7 March and left some sick soldiers with some supplies after five days, then they caught up with an advance party of roadbuilders and their military escort at Río Chakal. The two forces combined, giving Díaz a force of 49 soldiers and 34 porters and archers from Verapaz. Once they arrived at Ixb'ol, near the shore of Lake Petén Itzá, AjK'ixaw was sent ahead as an emissary to Nojpetén. How many months after Juan Díaz de Velasco's retreat did President Barrios die?

<transcription_page_footer> Page 52 </transcription_page_footer>
...
<transcription_page_footer>53</transcription_page_footer>
...
Q: By his first wife, Killigrew had four daughters: How many years after her marriage to Killigrew did Catherine die?  
...
<transcription_page_footer> 54 </transcription_page_footer>
...
| Accuracy change: (a_L / a_C) − 1 | +2.49 | −2.80 | +2.40 | +0.58 | +15.77 |

<transcription_json>
{"table_type":"data_table","title":"Accuracy by Steps","columns":["Accuracy by Steps","All","2","3","4","5+"],"data":[{"Accuracy by Steps":"Least-to-Most (1-shot): a_L","All":62.39,"2":74.53,"3":68.91,"4":59.73,"5+":45.23},{"Accuracy by Steps":"Chain-of-Thought (1-shot): a_C","All":60.87,"2":76.68,"3":67.29,"4":59.39,"5+":39.07},{"Accuracy by Steps":"Accuracy change: (a_L / a_C) - 1","All":2.49,"2":-2.80,"3":2.40,"4":0.58,"5+":15.77}],"unit":"percentage"}
</transcription_json>

<transcription_notes>
- Table 18 shows accuracy (%) for two prompting methods on GSM8K using GPT-3 code-davinci-002.
- Color/format cues in original: first row standard text; second row standard text; third row shows colored cells indicating positive (green) and negative (red) changes: +2.49 (green), −2.80 (red), +2.40 (green), +0.58 (green), +15.77 (green). 
- The "All" column is overall accuracy across all examples.
- "2" corresponds to examples requiring 2 reasoning steps (matching the demonstration in the prompt).
- "3", "4", "5+" correspond to examples requiring 3, 4, and 5 or more reasoning steps respectively.
</transcription_notes>
</transcription_table>
...
<transcription_json>
{"table_type": "data_table", "title": "Accuracies (%) of various prompting methods with the GPT-3 code-davinci-002 model on GSM8K", "columns": ["Prompting method", "Accuracy"], "data": [{"Prompting method": "Zero-Shot", "Accuracy": 16.38}, {"Prompting method": "Standard prompting", "Accuracy": 17.06, "footnote_ref": 3}, {"Prompting method": "Chain-of-Thought (original)", "Accuracy": 61.18}, {"Prompting method": "Chain-of-Thought (1-shot)", "Accuracy": 60.88}, {"Prompting method": "Least-to-Most (1-shot)", "Accuracy": 62.39}, {"Prompting method": "Chain-of-Thought (best)", "Accuracy": 68.61, "footnote_ref": 3}, {"Prompting method": "Least-to-Most (best)", "Accuracy": 68.01}], "unit": "percent"}
</transcription_json>

<transcription_notes>
- Table is centered on the page, single-column layout.
- Two entries (Standard prompting = 17.06 and Chain-of-Thought (best) = 68.61) carry a superscript footnote reference "3".
- Font: serif, small caps in header row. Cell borders visible.
- Source/context: comparison of prompting methods on GSM8K using GPT-3 code-davinci-002.
</transcription_notes>
</transcription_table>

3Note that in two of the prompt contexts used in an earlier pre-print of this paper, one of the examples had contained a mistake, which has been corrected in this version of the paper. Specifically, in the “Chain-of-Thought (best)” context, the last example had mistakenly omitted the final step, such that it ended incorrectly with “The answer is 17.” rather than “which means that sandy will get $20 - $17 = $3 as change. The answer is 3.” Similarly, the “Standard prompting” context incorrectly stated the answer as “17” rather than “3” for this example. The earlier versions of the prompts yielded the following accuracies: Standard prompting = 18.65, Chain-of-Thought (best) = 62.77.
...
<transcription_page_footer>58</transcription_page_footer>
...
<transcription_page_footer> 59 </transcription_page_footer>
...
A: Each bag was $6.00 but was 75% off. So each bag cost $6.00 * (1 - .75) = $6.00 * .25 = $1.50. Carla bought 2 bags. So she spent $1.50 * 2 = $3.00. The answer is 3.
