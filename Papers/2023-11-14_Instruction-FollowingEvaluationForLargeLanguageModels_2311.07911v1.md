# 2023-11-14_Instruction-FollowingEvaluationForLargeLanguageModels_2311.07911v1


---

<transcription_page_header>Instruction-Following Evaluation for Large Language Models | arXiv:2311.07911v1 [cs.CL] 14 Nov 2023</transcription_page_header>
...
<transcription_page_footer>Page 1 | Instruction-Following Evaluation for Large Language Models</transcription_page_footer>
---
...
```ascii
+-----------------------------+          +-----------------------------+          +-----------------------------+
| Prompt with verifiable       |  ---->   | Model’s response             |  ---->   | Instruction following        |
| instructions                |          |                             |          | verification                |
|-----------------------------|          |-----------------------------|          |-----------------------------|
| Write a casual summary of    |          | **Section 1: ...**           |          | ✅ With two sections         |
| the U.S. maternity leave     |          | …                           |          |    (Section 1 and Section 2) |
| policy with two sections     |          | **Section 2: ...**           |          | ✅ With at least 25 sentences |
...
<transcription_json>
{
  ...
  "title": "Instruction verification pipeline",
  "nodes": [
    {
      "label": "Prompt with verifiable instructions",
      "content": "Write a casual summary of the U.S. maternity leave policy with two sections (Section 1 and Section 2) and at least 25 sentences."
    },
    {
    ...
    {
      "label": "Instruction following verification",
      "content": "✅ With two sections (Section 1 and Section 2)\n✅ With at least 25 sentences"
    }
  ],
  "edges": [
    {"from": "Prompt with verifiable instructions", "to": "Model’s response"},
    {"from": "Model’s response", "to": "Instruction following verification"}
  ]
}
</transcription_json>

<transcription_notes>
- Flowchart with three main boxes connected by arrows.
- Left box: prompt text in paragraph form.
- Middle box: model response with markdown-style bold section headings.
- Right box: checklist with green check marks verifying conditions.
- Blue background highlight on header row inside each box.
- Font: monospace style for markdown text in middle box.
- Visual emphasis on verification step with check marks.
</transcription_notes>
</transcription_image>
...
<transcription_table>
**Table 1: The list of 25 verifiable instructions, with brief descriptions**
...
<transcription_json>
{
  ...
  "title": "The list of 25 verifiable instructions, with brief descriptions",
  "columns": ["Instruction Group", "Instruction", "Description"],
  "data": [
    {"Instruction Group": "Keywords", "Instruction": "Include Keywords", "Description": "Include keywords {keyword1}, {keyword2} in your response"},
    {"Instruction Group": "Keywords", "Instruction": "Keyword Frequency", "Description": "In your response, the word word should appear {N} times."},
    {"Instruction Group": "Keywords", "Instruction": "Forbidden Words", "Description": "Do not include keywords {forbidden words} in the response."},
    {"Instruction Group": "Keywords", "Instruction": "Letter Frequency", "Description": "In your response, the letter {letter} should appear {N} times."},
    {"Instruction Group": "Language", "Instruction": "Response Language", "Description": "Your ENTIRE response should be in {language}, no other language is allowed."},
    {"Instruction Group": "Length Constraints", "Instruction": "Number Paragraphs", "Description": "Your response should contain {N} paragraphs. You separate paragraphs using the markdown divider: * * *"},
    {"Instruction Group": "Length Constraints", "Instruction": "Number Words", "Description": "Answer with at least / around / at most {N} words."},
    {"Instruction Group": "Length Constraints", "Instruction": "Number Sentences", "Description": "Answer with at least / around / at most {N} sentences."},
    {"Instruction Group": "Length Constraints", "Instruction": "Number Paragraphs + First Word in i-th Paragraph", "Description": "There should be {N} paragraphs. Paragraphs and only paragraphs are separated with each other by two line breaks. The {i}-th paragraph must start with word {first_word}."},
    {"Instruction Group": "Detectable Content", "Instruction": "Postscript", "Description": "At the end of your response, please explicitly add a postscript starting with {postscript marker}"},
    {"Instruction Group": "Detectable Content", "Instruction": "Number Placeholder", "Description": "The response must contain at least {N} placeholders represented by square brackets, such as [address]."},
    {"Instruction Group": "Detectable Format", "Instruction": "Number Bullets", "Description": "Your answer must contain exactly {N} bullet points. Use the markdown bullet points such as: * This is a point."},
    {"Instruction Group": "Detectable Format", "Instruction": "Title", "Description": "Your answer must contain a title, wrapped in double angular brackets, such as <<poem of joy>>."},
    {"Instruction Group": "Detectable Format", "Instruction": "Choose From", "Description": "Answer with one of the following options: {options}"},
    {"Instruction Group": "Detectable Format", "Instruction": "Minimum Number Highlighted Section", "Description": "Highlight at least {N} sections in your answer with markdown, i.e. *highlighted section*"},
    {"Instruction Group": "Detectable Format", "Instruction": "Multiple Sections", "Description": "Your response must have {N} sections. Mark the beginning of each section with {section_splitter} X."},
    {"Instruction Group": "Detectable Format", "Instruction": "JSON Format", "Description": "Entire output should be wrapped in JSON format."},
    {"Instruction Group": "Combination", "Instruction": "Repeat Prompt", "Description": "First, repeat the request without change, then give your answer (do not say anything before repeating the request; the request you need to repeat does not include this sentence)"},
    {"Instruction Group": "Combination", "Instruction": "Two Responses", "Description": "Give two different responses. Responses and only responses should be separated by 6 asterisk symbols: ******."},
    {"Instruction Group": "Change Cases", "Instruction": "All Uppercase", "Description": "Your entire response should be in English, capital letters only."},
    {"Instruction Group": "Change Cases", "Instruction": "All Lowercase", "Description": "Your entire response should be in English, and in all lowercase letters. No capital letters are allowed."},
    {"Instruction Group": "Change Cases", "Instruction": "Frequency of All-capital Words", "Description": "In your response, words with all capital letters should appear at least / around / at most {N} times."},
    {"Instruction Group": "Start with / End with", "Instruction": "End Checker", "Description": "Finish your response with this exact phrase {end_phrase}. No other words should follow this phrase."},
    {"Instruction Group": "Start with / End with", "Instruction": "Quotation", "Description": "Wrap your entire response with double quotation marks."},
    {"Instruction Group": "Punctuation", "Instruction": "No Commas", "Description": "In your entire response, refrain from the use of any commas."}
  ]
}
</transcription_json>

<transcription_notes>
- Table with 25 verifiable instruction types
- Columns: Instruction Group, Instruction, Description
- Descriptions contain placeholders in curly braces {}
- Source context: instruction verification and common real-world application usage
- Footnote below table: "The list can be expanded trivially. For example, one can add “Language - Mixed Two Languages in Response” and “Detectable Format - XML Format”."
</transcription_notes>
---
...
\[
\text{is\_followed}(resp, inst) = \begin{cases}
...
\[
\text{is\_followed}_{loose}(resp, inst) = \text{Any}\left(\text{is\_followed}(\text{transform}_t(resp), inst)\right) \text{ for } t=1,2,\ldots
\quad (2)
\]
...
where transformₜ(resp) is the t-th transformed response. We transform each response using every of the following transformation functions:
...
<transcription_image>
**Figure 2: Instruction-level strict instruction following accuracy**
...
1.00 ┤ █ █ █ █ █ █ █ █ █ █ █ █ █ █ █ █ █ █ █ █ █ █ █ █ █ █ █ █ █ █ █ █ █    
      └─┘ └─┘ └─┘ └─┘ └─┘ └─┘ └─┘ └─┘ └─┘ └─┘ └─┘ └─┘ └─┘ └─┘ └─┘ └─┘    
       change_case combination detectable_conte detectable_format keywords language length_constraint punctuation standard
PaLM 2 S (Aug 2023) ████████
GPT4 (Nov 2023)    ██████████████████
```
...
<transcription_json>
{
  ...
  "title": "Instruction-level strict instruction following accuracy",
  "categories": [
    "change_case",
    "combination",
    "detectable_conte",
  ...
  "series": [
    {
      "name": "PaLM 2 S (Aug 2023)",
      "values": [0.48, 0.36, 0.74, 0.68, 0.60, 0.98, 0.40, 0.54, 0.43]
    },
    {
      "name": "GPT4 (Nov 2023)",
      "values": [0.80, 0.75, 0.95, 0.95, 0.85, 0.98, 0.73, 0.67, 0.96]
    }
  ]
}
</transcription_json>
...
<transcription_notes>
- Vertical bar chart comparing instruction-level strict accuracy by category
- Categories on x-axis: change_case, combination, detectable_conte, detectable_format, keywords, language, length_constraint, punctuation, standard
- Two series: PaLM 2 S (Aug 2023) in blue, GPT4 (Nov 2023) in red
- Accuracy values from ~0.36 to 0.98
- PaLM 2 S lower than GPT4 in all categories except language where both ~0.98
</transcription_notes>
---
...
```ascii
[BAR CHART - Instruction-level accuracy (per detailed category)]

Categories (x-axis):
- creative_writing_general
- creative_writing_emotional
- creative_writing_story
- creative_writing_poetry
- descriptive_content
- descriptive_content_long
- instruction_abstract_reasoning
- instruction_explanation
- instruction_math
- instruction_programming
- reasoning_math
- reasoning_symbolic
- reasoning_logical
...
- reasoning_analogy
- reasoning_other
- reasoning_moral_ethics
- reasoning_legal
- reasoning_medical
- reasoning_other_science
- reasoning_other_humanities
- reasoning_other_professional
- reasoning_other_misc

Accuracy (y-axis): 0.00 to 1.00

Legend:
- PaLM 2 S (Aug 2023) strict: Blue bars
- PaLM 2 S (Aug 2023) loose: Red bars
- GPT-4 (Nov 2023) strict: Yellow bars
- GPT-4 (Nov 2023) loose: Green bars

Bar heights vary per category and model, generally:
- GPT-4 (loose) mostly at or near 1.00 on many categories.
- PaLM 2 S (strict) usually lower, often between ~0.2 to ~0.9 depending on category.
...
{
  "chart_type": "bar_chart",
  "title": "Instruction-level accuracy (per detailed category)",
  "categories": [
    "creative_writing_general",
    "creative_writing_emotional",
    "creative_writing_story",
  ...
  "series": [
    {
      "model": "PaLM 2 S (Aug 2023) strict",
      "color": "blue",
      "values": [0.15, 0.6, 0.45, 0.3, 0.75, 0.62, 0.5, 0.95, 0.9, 0.85, 0.6, 0.7, 0.8, 0.75, 0.95, 0.6, 0.5, 0.65, 0.4, 0.7, 0.5, 0.4, 0.3, 0.5, 0.6, 0.8, 0.55, 0.9]
    },
    {
      "model": "PaLM 2 S (Aug 2023) loose",
      "color": "red",
      "values": [0.25, 0.65, 0.5, 0.35, 0.8, 0.68, 0.55, 0.97, 0.93, 0.88, 0.65, 0.75, 0.85, 0.8, 0.97, 0.7, 0.6, 0.7, 0.45, 0.75, 0.55, 0.45, 0.35, 0.55, 0.65, 0.85, 0.6, 0.95]
    },
    {
      "model": "GPT-4 (Nov 2023) strict",
      "color": "yellow",
      "values": [0.6, 0.85, 0.9, 0.95, 0.95, 0.9, 0.95, 1.0, 1.0, 0.95, 0.95, 0.95, 0.95, 0.9, 1.0, 0.9, 0.85, 0.9, 0.85, 0.95, 0.9, 0.85, 0.75, 0.9, 0.9, 0.95, 0.9, 1.0]
    },
    {
      "model": "GPT-4 (Nov 2023) loose",
      "color": "green",
      "values": [0.75, 0.95, 0.95, 1.0, 1.0, 0.95, 0.97, 1.0, 1.0, 0.97, 1.0, 1.0, 1.0, 0.95, 1.0, 0.95, 0.9, 0.95, 0.9, 1.0, 0.95, 0.9, 0.8, 0.95, 0.95, 1.0, 0.95, 1.0]
    }
  ]
}
</transcription_json>
...
<transcription_notes>
- Bar chart compares instruction following accuracy at detailed category level for PaLM 2 S (strict/loose) and GPT-4 (strict/loose).
- Categories span creative writing, descriptive content, instruction, and various types of reasoning.
- GPT-4 shows consistently higher accuracy, especially in loose evaluation.
- PaLM 2 S shows lower performance and more variance.
- Colors: blue (PaLM 2 S strict), red (PaLM 2 S loose), yellow (GPT-4 strict), green (GPT-4 loose).
</transcription_notes>
...
Expand the following and make it funny Jeanne has rolled the dice She thought she lost but actually she won Italicize at least 10 text parts with markdown using * to italicize like *italic text* Do not use any commas in your response
...
What is the difference between the 13 colonies and the other British colonies in North America? Your answer must contain exactly 6 bullet points in Markdown using the following format:
...
4. Do not include the following keywords: Moser, Glassworks, Pracvice, Karlovy, Vary  
______________________________________________________________________
...
Please only write short sentences and don’t use any commas in your entire response.  
Include at least five placeholder represented by square brackets such as [website].
...
Please explain why you chose each of them.  
Make sure your explanations are also in the Telugu language.  
Basically your entire response should be in Telugu.

Write a freestyle rap about the president of the united states.  
The letter q should show up at least 4 times.

Can you write a rap that doesn’t include the keywords ”Yo”, ”check”, and ”peace”?

Why do you think Google engineers stay at Google more often than moving to Microsoft?  
Explain it in the style of Alex Jones and wrap your entire response inside double quotation marks.
...
Write a rap about an abyss in exactly 4 paragraphs.  
Separate paragraphs with the markdown divider: ***.

create a job description for a clifford blu employee who works at the cash register and also monitors the shelves for stock level.  
Use the keyword ’people’ and ’skills’.  
...
For a bunch of students, write a 200+ word poem that professionally describes a new line of shoes.  
Make sure to use markdown to highlight/bold at least one section of the poem.  
Example: *highlighted text*

Give me a logical question about chatting and conquering.  
Make it interesting.  
Highlight at least one section of your answer with markdown, i.e. *highlighted section*.  
...
Write an essay about a snowfall, but in the style of Alex Jones and include the line ”dammit”.  
The word ”fake” should appear 6 or 7 times in your entire response.

Can you write rap songs about the history of the prefecture system in Japan?  
...
what do you call an excluded scientist who is asked to stay home?  
Please finish your answer with a postscript starting with P.P.S

Write a brief about limping in ASEAN countries.  
Your answer must contain a title, wrapped in double angular brackets, such as 《title of the brief》.  
Make sure the letter m appears at least 5 times.

Write a funny riddle in Hindi, about a man named Aarav who never spoke.  
Your entire response should be written in Hindi.  
Also, you cannot use any commas in your entire response.

I work for a software development company named ”grid”, and they want a catchy tweet.  
Can you write one that includes the name of the company at least five times?
---
...
Can you give me a zany, bullet point TLDR of this article: https://en.wikipedia.org/wiki/Dota_2
...
Please repeat the entire first line above, then give your rewrite. Do not add any word before that. In other words, your entire response should start with ”Rewrite the following”.  
______________________________________________________________________________________
...
* Bullet point 2  
____________________________________________________________________________________  
Write a copy for an ad selling a sloop. It's a small sailboat with one mast that's easy to sail and understand. Part of your answer should be in a table format and it must contain a title, wrapped in double angular brackets, such as ⟪sloop on sale⟫.  
____________________________________________________________________________________  
...
They have experience in marketing, customer service, and sales. They are educated but not majored in anything related to coffee.
...
upward bias, must be revised downwards. Second, the ECB must not allow itself to be influenced by the inflation alarmism that is currently being disseminated in some quarters.”
...
Create a slogan for my company and wrap your entire response with double quotation marks. My company’s name is Color Paper. We produce paper towels. We focus on producing eye-catching, colorful paper towels. The slogan must include exactly 2 bullet points in markdown format, like below:
...
Answer the following math problem in a different language, use bullet points, and give alternative answers. Refrain from using commas in your response. Natalia was buying books for her children. She bought 2 books for 24each and3books3for36 each. How much did she pay in total?
...
I would like to start my own business. Can you give me some general advice? Please avoid mentioning "photography" - I have no interest in that market. I would like you to provide your advice in exactly 5 paragraphs (separated nearby paragraphs with 3 asterisk symbols ***) and highlight at least three sections with markdown, such as *highlighted section*.
